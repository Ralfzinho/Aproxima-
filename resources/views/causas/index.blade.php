                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-gray-800" id="total-types">
                                {{ ($causas instanceof \Illuminate\Pagination\LengthAwarePaginator) ? $causas->total() : $causas->count() }}
                            </p>
                        </div>
                ...
                <div class="lg:col-span-2">
                    <div class="admin-card rounded-xl p-6">
                        ...
                        <div id="causas-list" class="space-y-4">
                                ...
                                <div class="type-card bg-white border rounded-lg p-4 flex items-center justify-between">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <a href="{{ route('causas.edit', $causa->id) }}"
                                            class="p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition" data-swal-edit
                                            data-title="Abrir edição?" data-text="Você vai para o formulário de edição."
                                            data-confirm="Ir para edição" data-cancel="Cancelar">
                                            Editar
                                        </a>
                                        ...
                                        <form action="{{ route('causas.destroy', $causa->id) }}" method="POST">
                                            ...
                                            <button type="submit"
                                                ...
                                                data-swal-delete data-title="Excluir causa?"
                                                data-text="Essa ação não pode ser desfeita." data-confirm="Excluir"
                            ...
                            @empty
                                <div class="text-gray-500">Nenhuma causa cadastrada.</div>
                            @endforelse
                            @if ($causas->hasPages())
                                <div class="pagination">
                                    <div class="pagination-info">
                                        Página {{ $causas->currentPage() }} de {{ $causas->lastPage() }}
                                    </div>
