<body>
    <div class="container">
        ...
        <div class="mt-3">
            <a href="{{ route('causas.index') }}" class="btn btn-secondary">Voltar</a>
            <a href="{{ route('causas.edit', $ajuda->id) }}" class="btn btn-primary">Editar</a>
            <form action="{{ route('causas.destroy', $ajuda->id) }}" method="POST" style="display:inline-block;">
                @csrf
                @method('DELETE')
